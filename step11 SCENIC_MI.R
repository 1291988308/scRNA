...
setwd("/home/shpc_100537/MI_SCENIC")
dir.create("/home/shpc_100537/MI_SCENIC/DoRothEA")
setwd("/home/shpc_100537/MI_SCENIC/DoRothEA")
...
obj.combined <- subset(obj.combined,idents="MI")
...
combine.sub <- obj.combined[,subcell]
